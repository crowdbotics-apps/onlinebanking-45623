"""
Django settings for onlinebanking_45623 project.
...
ROOT_URLCONF = 'onlinebanking_45623.urls'
...
WSGI_APPLICATION = 'onlinebanking_45623.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "onlinebanking_45623 API",
    "DESCRIPTION": "API documentation for onlinebanking_45623 App",
    "VERSION": "v1",
}
